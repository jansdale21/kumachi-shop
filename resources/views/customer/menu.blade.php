<x-layouts.customer title="Kumachi | Menu">
    @push('styles')
        <link rel="stylesheet" href="{{ asset('css/customer/menu.css') }}">
    @endpush

    <section class="content-section menu-page">
        <div class="menu-shell">
            <div class="menu-header">
                <h1>Our Menu</h1>
                <p>Discover our handcrafted beverages and fresh pastries.</p>
            </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="product-body">
                                    ...
                                    <div class="product-footer"><strong>₱{{ number_format((float) $product->base_price, 2) }}</strong><span>View Details</span></div>
                                </div>
                            </article>
                        </a>
                    @endforeach
            ...
            <section class="menu-section" id="unavailableSection">
                ...
                <div class="menu-grid" id="menuGridUnavailable">
                    @foreach ($products->where('availability', 'unavailable') as $product)
                        ...
                        >
                            <article
                                class="product-card menu-card menu-card-disabled"
                            >
                                @if ($product->image_path)
                                    <div class="product-art" style="overflow: hidden;">
                                        <img
