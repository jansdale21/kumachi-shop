<x-layouts.customer title="Kumachi | Cart">
    @push('styles')
        ...
        <div class="cart-shell">
            ...
            @if ($cart->items->isEmpty())
                <section class="cart-panel cart-empty">
                    ...
                    <a href="{{ route('menu') }}">Browse Menu</a>
                </section>
            @else
                        ...
                        <article class="cart-item">
                            <div class="cart-item-main">
                                ...
                                <div class="cart-item-controls">
                                    <form method="POST" action="{{ route('cart.items.update', $item) }}" class="qty-form" data-qty-form>
                                        @csrf
                                        @method('PATCH')
                ...
                <section class="cart-panel summary-panel">
                    ...
                    <a href="{{ route('menu') }}" class="continue-link">Continue Shopping</a>
                </section>
            @endif
        </div>
    </section>
